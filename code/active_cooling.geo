...
cpu_surfaces[] = Surface In BoundingBox {0, -14, 4.5, 19, 3.2, 8.5};
cooler_surfaces_1[] = Surface In BoundingBox {-20.71, -9.9, 8.33, 36.7, 20.6, 19.5};
cooler_surfaces_2[] = Surface In BoundingBox {-3.70, -19.5, 8.33, 36.7, 20.6, 19.5};
cpu_surfaces[] += cooler_surfaces_1[];
cpu_surfaces[] += cooler_surfaces_2[];
Physical Surface("CPU_And_Cooler") = {cpu_surfaces[]};
...
Mesh 3;
Save "active_cooling_simulation_mesh.msh";
